        ...
        success: function (result) {
            ...
            if (errorMessage.status == 401) {
                Swal.fire({
                    icon: 'error',
                    title: 'Error',
                    text: 'El nombre del dueño es incorrecto o la cantidad de jugadores no es correcta',
        ...
        error: function (errorMessage) {
            if (errorMessage.status == 401) {
                Swal.fire({
                    icon: 'error',
                    title: 'Error',
                    text: 'La contraseña es incorrecta o la cantidad de jugadores no es correcta',
                    showConfirmButton: false,
                    timer: 1800
                });
